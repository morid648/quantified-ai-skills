...
const BUNDLE_RULES = {
  ...
  "ai-training-eval": {
    description:
      "AI training data quality, evaluation harnesses, and regression tracking.",
    keywords: ["ai-training-eval"],
  },
  "context-optimization": {
    description:
      "Document chunking and context budget allocation for long-document LLM pipelines.",
    keywords: ["context-optimization"],
  },
  "prompt-engineering": {
    description:
      "Prompt scorecard testing and finance-domain extraction prompt libraries.",
    keywords: ["prompt-engineering"],
  },
  "ai-annotation": {
    description:
      "Annotation guideline writing, QA scoring, and finance document annotation.",
    keywords: ["ai-annotation"],
  },
  "quantified-eval-suite": {
    description: "The complete 11-skill unified pipeline orchestrator.",
    keywords: ["quantified-eval-suite"],
  },
};
